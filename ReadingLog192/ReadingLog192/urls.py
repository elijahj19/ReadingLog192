...
from main.views import splash_view, about_view, dashboard_view, accounts_view, login_view, signup_view, logout_view, progress_view, classes_view, authors_view, authorReadings_view, classReadings_view
